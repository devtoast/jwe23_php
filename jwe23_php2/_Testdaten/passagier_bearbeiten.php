...
if (!empty($_POST)) {
    ...
    // Updaten
    query("UPDATE passagiere SET passagier_id='{$sql_passagier_id}', flug_id='{$sql_flug_id}', vorname='{$sql_vorname}', nachname='{$sql_nachname}', geburtsdatum='{$sql_geburtsdatum}', flugangst='{$sql_flugangst}' WHERE passagier_id='{$sql_passagier_id}'");
...
if ($erfolg) {
    echo "<p><strong>Passagier wurde bearbeitet.</strong></p>";
} else {
}
