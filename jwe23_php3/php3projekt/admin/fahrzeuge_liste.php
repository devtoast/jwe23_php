...
echo "<th>Model</th>";
echo "<th>Farbe</th>";
echo "<th>Fahrzeug_Identifikations-Nr.</th>";
echo "<th>Optionen</th>";
echo "</thead>";
...
foreach ($alleFahrzeuge as $auto) {
    ...
    echo "<td>" . $auto->fin . "</td>";
    echo "<td>" . "<a href='fahrzeuge_bearbeiten.php?id={$auto->id}'>Bearbeiten</a>" .  "<br>" . "<a href='fahrzeuge_entfernen.php?id={$auto->id}'>Entfernen</a>" . "</td>";
